...
const columns = ref([
  ...
  { data: 'blanco_biologico', title: 'Blanco Biologico' },
  {
    data: null,
    render: '#action',
    title: 'Action',
...
function getBlancoBiolProd() {
  axios.get('/biolog_x_product').then(function (response) {
...
defineExpose({ data, getBlancoBiolProd });
</script>
